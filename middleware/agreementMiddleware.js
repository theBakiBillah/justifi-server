...
// memoryStorage: req.body fields ARE available in the route handler after
// multer parses multipart. We manually write to disk in the route.
// fileFilter is intentionally omitted — jsPDF blobs can have inconsistent
// MIME types; validation is done in the route handler instead.
const agreement = multer({
